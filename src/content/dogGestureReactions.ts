...
export const dogGestureReactions: Partial<Record<GestureName, DogReaction>> = {
  petting: {
    ...
    dogState: "petting",
    label: "쓰담쓰담",
    image: "/assets/dog/optimized/dog-petting.png",
  ...
  fingerHeart: {
    ...
    label: "손가락하트",
    image: "/assets/dog/optimized/dog-heart.png",
  ...
  poke: {
    ...
    dogState: "poke",
    label: "콕콕 찌르기",
    image: "/assets/dog/optimized/dog-poke.png",
  ...
  wave: {
    ...
    dogState: "wave",
    label: "인사",
    image: "/assets/dog/optimized/dog-wave.png",
  ...
  openPalm: {
    ...
    dogState: "happy",
    label: "손바닥 인사",
    image: "/assets/dog/optimized/dog-happy.png",
    speech: ["안녕~ 나는 포도야!", "소담이누나 안녕~"],
    effect: "petal",
  },
  pinch: {
  ...
  fist: {
    ...
    dogState: "thinking",
    label: "주먹",
    image: "/assets/dog/optimized/dog-punch.png",
  ...
  swipeLeft: {
    ...
    dogState: "happy",
    label: "간지럽히기",
    image: "/assets/dog/optimized/dog-sleep.png",
  ...
  swipeRight: {
    ...
    dogState: "happy",
    label: "브이",
    image: "/assets/dog/optimized/dog-v.png",
